...
| `js/brain/curriculum.js:16906` | **0.05** | The P5.3 **quality-bonus** noise floor — below it, `coherenceBonus` is simply not added. **Not a rejection gate at all** |
| `js/brain/curriculum.js:18502` | **0.80** | `_probeCM2MysteryPsiCoherence` per-trial threshold, 15 trials |
