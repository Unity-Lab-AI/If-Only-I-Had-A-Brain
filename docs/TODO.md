...
- [ ] `SPONGEHAND.B1-B7` — ⏳ **AWAITING GEE'S SCOPE CALL.** Sponge (verbatim): *"**B7. Extract curriculum/vocabulary data** — do this early, it shrinks everything … Worth doing even if the rewrite stalls."*
