...
- [~] `TEXTBOOK.1` — ⏳ **THE HOST QUESTION IS ANSWERED 2026-09-02; THE INGEST IS NOT STARTED.** `CURVEDEPTH.14`'s probe found **LibreTexts — ≥295,534 pages across 8 libraries**, and the libraries line up with this row's own gap list one for one: `human` 75,004 against art 20 / language 10 / music 13 · `socialsci` 74,685 against social 17 / psychology 4 · `med` 29,535 against health 13 / pe 13 · `eng` 24,459 against cs 8 / cstheory 4 / cssystems 4 · `biz` 33,332 against economics 3.
