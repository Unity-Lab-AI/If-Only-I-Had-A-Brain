...
- [~] `CURVEDEPTH.12` — ⏳ **PROGRESS 2026-09-04, AND THE ROW'S PREMISE NEEDED CORRECTING — the lane it asks for was ALREADY BUILT, and the debt was never a missing host.**
  ...
  - **Measured: owed 1,999,649 → 1,796,637 · `major` 514,295 → 373,432 · `cssystems/college3` 72,236 → 50,518.** Synced to BrainWaves at `140342d1`, staged explicitly, **0 deletions, 26,359 fields verified still tracked**.
  - ⏳ **STILL OWED, AND NAMED: `cstheory` 612,443 — the largest single debt left in the corpus**, concentrated in `college2` (213,160) and `college1` (182,433). Those two want **discrete mathematics, algorithms and theory-of-computation** texts specifically; the Green Tea set does not cover them and the best theory book found (Barak) is **CC-BY-NC-ND**, already on this file's refused list.
