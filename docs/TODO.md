...
- [~] `FLAGSAMPLE.2` — ⛔⛔ **ANSWERED IN HALF, AND THE HALF THAT IS NOT EXPECTED IS A REAL DEFECT.** The samples fix landed on the box and the flag now names what missed: **8 distinct words — `for` · `be` · `your` · `their` · `look` · `our` · `america` · `every`** — which split cleanly:
