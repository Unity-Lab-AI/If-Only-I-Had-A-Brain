...
- [ ] `CODELEAK.1` — ⛔ **786 SOURCE-COMMENT LINES BREAK THE TASK-NUMBER AND VERBATIM-WORDS PLACEMENT LAWS, MEASURED NOT ESTIMATED.** Found while collapsing the figure-key rule; the files being edited were sitting next to it.
