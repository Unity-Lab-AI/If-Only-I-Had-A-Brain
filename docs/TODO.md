...
- [ ] `REGFIND.9` — ⛔⛔ **AN ENTIRE BUILT FEATURE IS UNREACHABLE: ON-THE-FLY MEMORY DERIVATION. THREE METHODS, ZERO CALLERS, AND IT CARRIES A SAFETY GATE THAT THEREFORE PROTECTS NOTHING.**
