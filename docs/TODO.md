...
- [ ] `RUSTSCOPE.2` — ⏳ **WHAT IS GENUINELY LEFT, AND THE THREE IMMEDIATE ITEMS THAT ARE NOT REWRITE WORK AT ALL.** From the note's own task list, minus what has since shipped:
