...
- [ ] `EARLYTEACH.2` — **TEACH COUNTING, NUMERALS AND READING A NUMBER SENTENCE IN THE EQUATIONAL MATH RUNNERS.** Gee's decision, 2026-09-03: the number half of early instruction lives in the maths curriculum, **not in a prose lane** — no carve-out to the equational-math law, and the primary arithmetic primer that Gutenberg does not have is no longer needed.
