...
- [ ] `SPONGEHAND.B1-B6` — ⏳ **THE REMAINING RUST PHASES — RE-PRICE BEFORE STARTING, per the B7 finding above.** Sponge (verbatim): *"**B7. Extract curriculum/vocabulary data** — do this early, it shrinks everything … Worth doing even if the rewrite stalls."*
