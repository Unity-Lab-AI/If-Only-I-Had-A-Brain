...
- [ ] `FIELDSIZE.3` — ⏳ **THE ENCODING LEVER, AND IT NEEDS GEE'S CALL BECAUSE IT IS THE ONLY REMAINING WAY UNDER ~180 GB THAT DOES NOT COST HER ANY PERCEPTION.** `FIELDSIZE.1` restored the corpus norm and took the projection 537 GB → **~182 GB**, one copy in Forgejo and one on the box. Gee's baseline was *"100G"*, so the gap is real and named rather than quietly accepted.
