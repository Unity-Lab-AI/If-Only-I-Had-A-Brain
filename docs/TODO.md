...
>
> **Original filing:**
- [~] `CELLRACE.2` — ⭐ **AUDIT RUN 2026-09-02 (both ingests finished). STRUCTURALLY CLEAN — AND THAT IS NOT PROOF, WHICH IS THE POINT OF THE ROW.**
  ```
  ...
  - ⏳ **OWED: the confirming re-run.** Deferred while the figure-field job holds the CPU and network — the audit is only meaningful once academic can actually replace its own entries, which it now can.
