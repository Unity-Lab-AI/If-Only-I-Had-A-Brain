...
const TOPICS = {
  ...
  art: {
    ...
    grade9: ['Art history', 'Aesthetics', 'Art criticism', 'Painting', 'Drawing', 'Sculpture', 'Photography', 'Digital art', 'Composition (visual arts)', 'Colour theory', 'Design', 'Career portfolio'],
    ...
    grade12: ['Art theory', 'Aesthetics', 'Art criticism', 'Museum', 'Curator', 'Art market', 'Visual culture', 'Semiotics', 'Career portfolio', 'Art school'],
