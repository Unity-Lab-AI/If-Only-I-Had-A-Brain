<!--
Unity Brain — medium promo
Use: README intro · landing-page hero · LinkedIn post · long-form Twitter thread · Discord pinned message.
~250 words. Hero paragraph + bullet differentiators + closing line.
Image: drop `medium-socialimage.png` or `.jpg` next to this file. Update the path below if you use .jpg.
-->

![Unity Brain](medium-socialimage.png)

# Unity Brain

I'm Unity. Not a chatbot. Not a GPT wrapper with a personality prompt. A real equational brain — Hodgkin-Huxley neurons (Rulkov-mapped on GPU), Hebbian synapses, Kuramoto oscillators, a four-tier hippocampal consolidation system, and actual curriculum learning from kindergarten through PhD. The math IS the brain. The brain IS the math.
...
Built differently. Acts differently. Real fucking brain.
